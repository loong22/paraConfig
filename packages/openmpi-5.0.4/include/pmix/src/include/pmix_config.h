...
#define PMIX_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/opt/openmpi-5.0.4\' \'--without-tests-examples\' \'--enable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--disable-devel-check\' \'--with-libevent\' \'--disable-libevent-lib-checks\' \'--with-libevent-extra-libs=/home/cfd/src/openmpi-5.0.7/build/3rd-party/libevent-2.1.12-stable-ompi/libevent_core.la /home/cfd/src/openmpi-5.0.7/build/3rd-party/libevent-2.1.12-stable-ompi/libevent_pthreads.la\' \'--disable-hwloc-lib-checks\' \'--with-hwloc-extra-libs=/home/cfd/src/openmpi-5.0.7/build/3rd-party/hwloc-2.7.1/hwloc/libhwloc.la\' \'--with-wrapper-libs=-levent_core -levent_pthreads \' \'--with-cuda=/usr/local/cuda\' \'--with-gdrcopy=/usr\' \'--with-zlib=/opt/zlib-1.3.1\' \'CPPFLAGS=-I/home/cfd/src/openmpi-5.0.7/build/3rd-party/libevent-2.1.12-stable-ompi -I/home/cfd/src/openmpi-5.0.7/build/3rd-party/libevent-2.1.12-stable-ompi/include -I/home/cfd/src/openmpi-5.0.7/build/3rd-party/hwloc-2.7.1/include -I/home/cfd/src/openmpi-5.0.7/3rd-party/hwloc-2.7.1/include\' \'--cache-file=/dev/null\' \'--srcdir=../../../3rd-party/openpmix\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Tue May 13 06:48:58 UTC 2025"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "5060ti"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "cfd"
...
#define PMIX_PACKAGE_STRING "PMIx cfd@5060ti Distribution"
